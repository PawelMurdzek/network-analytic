...
\begin{titlepage}
    ...
    {\large \textbf{Data:} 30.11.2025, 14:47}
...
\hline
Całkowita liczba przepływów & 391 \\
Unikalne IP źródłowe & 106 \\
Unikalne IP docelowe & 42 \\
Całkowita liczba pakietów & 430 \\
Całkowita liczba bajtów & 71,102 \\
Średnia pakietów/przepływ & 1.10 \\
Średnia bajtów/przepływ & 181.85 \\
\hline
\end{tabular}
\end{table}
...
System detekcji zidentyfikowal \textbf{21} alertow bezpieczenstwa.
...
\hline
\alerthigh{HIGH/CRITICAL} & 11 & 52.4\% \\
\alertmedium{MEDIUM} & 10 & 47.6\% \\
\alertlow{LOW} & 0 & 0.0\% \\
\hline
\textbf{RAZEM} & \textbf{21} & \textbf{100\%} \\
\hline
\end{tabular}
\end{table}
...
\endhead
        ...
        12 & Metasploit Reverse Shell Conne & \alerthigh{CRITICAL} & Detects connections to port 4444, the default port \\
        13 & Metasploit Reverse Shell Conne & \alerthigh{CRITICAL} & Detects connections to port 4444, the default port \\
        14 & Metasploit Reverse Shell Conne & \alerthigh{CRITICAL} & Detects connections to port 4444, the default port \\
        15 & Metasploit Reverse Shell Conne & \alerthigh{CRITICAL} & Detects connections to port 4444, the default port \\
\hline
\end{longtable}
...
\hline
        ...
        Custom Backdoor Port Detection & CRITICAL & T1095 \\
...
\begin{itemize}
    ...
    \item \textbf{True Negatives (TN)}: 115 -- poprawnie sklasyfikowany normalny ruch
...
\begin{enumerate}
    \item Przeanalizowano \textbf{391} przeplywow sieciowych
    \item Wykryto \textbf{21} alertow bezpieczenstwa, w tym \textbf{11} o wysokim priorytecie
    \item Ruch sieciowy obejmowal \textbf{106} unikalnych zrodlowych i \textbf{42} docelowych adresow IP
